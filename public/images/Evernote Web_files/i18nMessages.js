window.__EVERNOTE_I18N__ = {
 "generatedOn": "2016-Jul-20 15:00 PDT",
 ...
 "CancelSubscriptionAction.CancelReasonCode.CHANGE_PAYMENT_METHOD.helpTip": "Did you know you can <a href=\"/UpdateBilling.action\">change your billing info</a>?",
 "CancelSubscriptionAction.CancelReasonCode.CHANGE_SUBSCRIPTION_PLAN.helpTip": "Did you know you can <a href=\"/UpdateBilling.action\">manage your subscription</a>?",
 ...
 "ChangeSubscriptionAction.header": "Change Subscription Plan",
 "ChangeSubscriptionAction.text": "Subscription Plan",
 "ChangeSubscriptionAction.text.note": "Changes to your Premium subscription plan will only be applied after the end of your current billing cycle.",
 "ChangeSubscriptionAction.text.premium-1mon": "Monthly Subscription",
 "ChangeSubscriptionAction.text.premium-1year": "Annual Subscription",
 "ChangeSubscriptionAction.text.currentPlan": "Current Plan",
 "ChangePaymentMethodAction.header": "Change Payment Method",
 "ChangePaymentMethodAction.header.creditcard": "Change Credit Card Used",
 "ChangePaymentMethodAction.error.notEligible.AMAZON": "We can not change your subscription. See <a href=\"http://www.amazon.com/gp/help/customer/display.html?nodeId=201112130\">http://www.amazon.com/gp/help/customer/display.html?nodeId=201112130</a>.",
 "ChangePaymentMethodAction.error.notEligible.ITUNES": "We can not change your subscription. See <a href=\"http://support.apple.com/kb/ht4098\">http://support.apple.com/kb/ht4098</a>",
 "ChangePaymentMethodAction.error.notEligible.general": "We can not change your subscription.",
 "ChangePaymentMethodAction.text.current": "For your Premium subscription you are currently using:",
 "ChangePaymentMethodAction.text.changeCard": "Change this to another card on file or add a new card:",
 "ChangePaymentMethodAction.header.creditCardInfo": "Credit Cards on File",
 "ChangePaymentMethodAction.text.existingCardDescription": "{{ 0 }} ending in {{ 1 }}",
 "ChangePaymentMethodAction.text.useExistingCard": "Start using this card for your Premium subscription",
 "ChangePaymentMethodAction.text.newCard": "Add a New Card",
 "ChangePaymentMethodAction.text.useNewCard": "Add a new card for your Premium subscription",
 "ChangePaymentMethodAction.header.billingAddress": "Billing Address",
 "ChangePaymentMethodAction.text.defaultAddress": "Use default Billing Address",
 "ChangePaymentMethodAction.text.newAddressDescription": "Add a new Billing Address for this card",
 "ChangePaymentMethodAction.text.externalRecurring": "If you update your credit card on this page, your subscription will be renewed on {{ 0 }} and Evernote will charge your credit card directly. If you wish to keep paying via {{ 1 }}, please update your credit card via your {{ 1 }} account instead.",
 "ChangePaymentMethodAction.text.denotesRequiredField": "<dfn>*</dfn> denotes required field.",
 ...
 "BackToSchoolEmailAction.emailDoesNotMatch": "\"<em>{{ 0 }}</em>\" does not match.",
 ...
 "ManageNotebooksAction.shareNotebook.feedback.failure.singular": "Failed to share {{ 0 }} with {{ 1 }}.",
 "ManageNotebooksAction.shareNotebook.feedback.success": "Successfully shared {{ 0 }} notebooks with {{ 1 }}.",
 "ManageNotebooksAction.shareNotebook.feedback.success.singular": "Successfully shared {{ 0 }} with {{ 1 }}.",
 ...
 "IE7Incompatible.title": "We recommend trying a different browser",
 "IE7Incompatible.warning": "You may not enjoy the full Evernote experience with your current browser.",
 "IE7Incompatible.suggestion": "Try Internet Explorer 9 or 10, Chrome, Firefox or Safari for best performance.",
 "IE7Incompatible.dismiss": "No thanks, proceed with my current browser.",
 ...
 "ChangeSubscriptionAction.title": "Change Subscription",
